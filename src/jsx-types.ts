export namespace JSX {
  ...
  //   [k: string]: any;
  // };
  export type IntrinsicElements = iii;
}
...
// type xxx = PickByKey<HTMLAudioElement>;
...
type GetReadonlyKeys<T, U extends Readonly<T> = Readonly<T>, K extends keyof T = keyof T> = K extends keyof T
...
//   a: 'name' | 'age';
// };
// type PickJsxAttr1<T, k> = Omit<
//   PickByValueType<T, string | number | boolean>,
//   GetReadonlyKeys<T> | (k extends keyof OmitKeys ? OmitKeys[k] : never)
// >;
